            ...
            <div class="nxl-drp-link nxl-lavel-mega-menu">
                ...
                <div class="nxl-lavel-mega-menu-wrapper d-flex gap-3">
                    ...
                    <div class="dropdown nxl-h-item nxl-lavel-menu">
                        <a href="#;" class="avatar-text avatar-md bg-primary text-white" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                    ...
                    <div class="dropdown nxl-h-item nxl-mega-menu">
                        <a href="#;" class="btn btn-light-brand" data-bs-toggle="dropdown" data-bs-auto-close="outside"> Mega Menu </a>
                            ...
                            <div class="d-lg-flex align-items-start">
                                ...
                                <div class="tab-content nxl-mega-menu-tabs-content">
                                    ...
                                    <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                        ...
                                        <a href="#;" class="fs-13 fw-bold text-primary">Get Started &rarr;</a>
                                    </div>
                                    <!--! [End] v-pills-general !-->
                                    ...
                                    <div class="tab-pane fade" id="v-pills-applications" role="tabpanel">
                                        ...
                                        <div class="d-lg-flex align-items-center justify-content-between">
                                            ...
                                            <div class="mt-2 mt-lg-0">
                                                <a href="http://bestwpware.com/cdn-cgi/l/email-protection#f285809382919d96978081b2959f939b9edc919d9f" class="fs-13 fw-bold text-primary">Contact Us &rarr;</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                        <div class="row g-lg-4 nxl-mega-menu-integrations">
                                            <div class="col-lg-12 d-lg-flex align-items-center justify-content-between mb-4 mb-lg-0">
                                                ...
                                                <div class="mt-2 mt-lg-0">
                                                    <a href="#;" class="fs-13 text-primary">Add New &rarr;</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <a href="#;" class="dropdown-item">
                                        ...
                                        <hr class="border-top-dashed" />
                                        <p class="fs-13 text-muted mb-0">Need help? Contact our <a href="#;" class="fst-italic">support center</a></p>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                        <div class="row g-4 align-items-center">
                                            <div class="col-xl-8">
                                                <div class="row g-4">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="#;" class="dropdown-item">Timesheets</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="#;" class="dropdown-item">Documentations</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <h6 class="dropdown-item-title">Authentication</h6>
                                                        <a href="#;" class="dropdown-item">Login</a>
                                                        <a href="#;" class="dropdown-item">Regiser</a>
                                                        <a href="#;" class="dropdown-item">Error-404</a>
                                                        <a href="#;" class="dropdown-item">Reset Pass</a>
                                                        <a href="#;" class="dropdown-item">Verify OTP</a>
                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <div class="mt-4">
                                                    <a href="http://bestwpware.com/cdn-cgi/l/email-protection#95e2e7f4e5f6faf1f0e7e6d5f2f8f4fcf9bbf6faf8" class="fs-13 fw-bold">View all resources on Duralux &rarr;</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="tab-pane fade active show" id="v-pills-projects" role="tabpanel">
                                                <div class="row g-4">
                                                    <div class="col-xxl-2 d-lg-none d-xxl-block">
                                                        ...
                                                        <a href="#;" class="dropdown-item">Applicatios</a>
                                                        <a href="#;" class="dropdown-item">eCommerce</a>
                                                                ...
                                                                <div class="d-lg-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                        ...
                                                                        <div class="hstack gap-2 mt-3">
                                                                            ...
                                                                            <a href="#;" class="fs-12">Alexandra Della</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="d-lg-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                        ...
                                                                        <div class="hstack gap-2 mt-3">
                                                                            ...
                                                                            <a href="#;" class="fs-12">Green Cute</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="d-lg-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                        ...
                                                                        <div class="hstack gap-2 mt-3">
                                                                            ...
                                                                            <a href="#;" class="fs-12">Malanie Hanvey</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="d-lg-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                        ...
                                                                        <div class="hstack gap-2 mt-3">
                                                                            ...
                                                                            <a href="#;" class="fs-12">Kenneth Hune</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row g-4">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="p-3 bg-soft-dark text-dark rounded d-lg-flex align-items-center justify-content-between">
                                                                    ...
                                                                    <div class="mt-2 mt-lg-0">
                                                                        <a href="#;" class="fs-13 text-primary">Learn More &rarr;</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                    ...
                                                    <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                        ...
                                                        <div class="mt-4">
                                                            <a href="http://bestwpware.com/cdn-cgi/l/email-protection#087f7a69786b676c6d7a7b486f65696164266b6765" class="fs-13 fw-bold">View all features on Duralux &rarr;</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="d-flex align-items-center">
                        ...
                        <div class="search-items-wrapper">
                            <div class="searching-for px-4 py-2">
                                ...
                                <div class="d-flex flex-wrap gap-1">
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Projects</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Leads</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Contacts</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Inbox</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Invoices</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Tasks</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Customers</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Notes</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Affiliate</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Storage</a>
                                    <a href="#;" class="flex-fill border rounded py-1 px-2 text-center fs-11 fw-semibold">Calendar</a>
                                </div>
                            </div>
                            <div class="dropdown-divider"></div>
                            <div class="recent-result px-4 py-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">CRM dashboard redesign</a>
                                            <p class="fs-11 text-muted mb-0">Home / project / crm</p>
                                        </div>
                                    </div>
                                    <div>
                                        <a href="#;" class="badge border rounded text-dark">/<i class="feather-command ms-1 fs-10"></i></a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Create new document</a>
                                            <p class="fs-11 text-muted mb-0">Home / tasks / docs</p>
                                        </div>
                                    </div>
                                    <div>
                                        <a href="#;" class="badge border rounded text-dark">N /<i class="feather-command ms-1 fs-10"></i></a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Invite project colleagues</a>
                                            <p class="fs-11 text-muted mb-0">Home / project / invite</p>
                                        </div>
                                    </div>
                                    <div>
                                        <a href="#;" class="badge border rounded text-dark">P /<i class="feather-command ms-1 fs-10"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="users-result px-4 py-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Alexandra Della</a>
                                            <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="86e7eae3fea8e2e3eaeae7c6e9f3f2eae9e9eda8e5e9eb">[email&#160;protected]</a></p>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Green Cute</a>
                                            <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="83e4f1e6e6edade0f6f7e6c3ecf6f7efecece8ade0ecee">[email&#160;protected]</a></p>
                                        </div>
                                    </div>
                                    <a href="#;" class="avatar-text avatar-md">
                                        <i class="feather-chevron-right"></i>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Malanie Hanvey</a>
                                            <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2f424e434e41464a014e41594a566f405a5b43404044014c4042">[email&#160;protected]</a></p>
                                        </div>
                                    </div>
                                    <a href="#;" class="avatar-text avatar-md">
                                        <i class="feather-chevron-right"></i>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Kenneth Hune</a>
                                            <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0368666d776b2d6b766d66436c76776f6c6c682d606c6e">[email&#160;protected]</a></p>
                                        </div>
                                    </div>
                                    <a href="#;" class="avatar-text avatar-md">
                                        <i class="feather-chevron-right"></i>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-0">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Archie Cantones</a>
                                            <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="066774656e6f63286569686375466973726a69696d2865696b">[email&#160;protected]</a></p>
                                        </div>
                                    </div>
                                    <a href="#;" class="avatar-text avatar-md">
                                        <i class="feather-chevron-right"></i>
                            ...
                            <div class="file-result px-4 py-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Project Style CSS</a>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Dashboard Project Zip</a>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-0">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Project Document PDF</a>
                            ...
                            <a href="#;" class="p-3 fs-10 fw-bold text-uppercase text-center d-block">Loar More</a>
                        </div>
                    </div>
                </div>
                <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                    <a href="#;" class="nxl-head-link me-0 nxl-language-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-language-dropdown">
                        ...
                        <div class="language-items-wrapper">
                            <div class="select-language px-4 py-2 hstack justify-content-between gap-4">
                                ...
                                <a href="#;" class="avatar-text avatar-md" data-bs-toggle="tooltip" title="Add Language">
                                    <i class="feather-plus"></i>
                                </a>
                            </div>
                            <div class="dropdown-divider"></div>
                ...
                <div class="nxl-h-item d-none d-sm-flex">
                    <div class="full-screen-switcher">
                        <a href="#;" class="nxl-head-link me-0" onclick="$('body').fullScreenHelper('toggle');">
                ...
                <div class="dropdown nxl-h-item">
                    <a href="#;" class="nxl-head-link me-0" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                        ...
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="fs-12 fw-medium text-muted"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6b0a070e13450f0e07070a2b041e1f0704040045080406">[email&#160;protected]</a></span>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown">
