        ...
        <div class="main-content d-flex">
            ...
            <div class="content-area ps ps--active-y" data-scrollbar-target="#psScrollbarInit">
                                ...
                                <div class="dropdown me-1">
                                    <button id="dropdownMenu-calendarType" class="dropdown-toggle calendar-dropdown-btn"
                                        ...
                                        <i id="calendarTypeIcon"
                                            class="calendar-icon feather feather-grid fs-12 me-1"></i>
                ...
                <div class="content-area-body p-0">
                    <div id="tui-calendar-init">
                        <div class="tui-full-calendar-layout tui-view-1 tui-view-9 tui-view-14 tui-view-17"
                            ...
                            <div
                                class="tui-full-calendar-month tui-view-4 tui-view-5 tui-full-calendar-vlayout-container">
                ...
                ">
                                ...
                                <div class="tui-view-8" data-panel-index="1" data-auto-height="true"
                                    style="height: 915.2px;">
            ...
            " style="top:34px;left:85.71428571428572%;width:14.285714285714286%;height:0px;
                margin-top:2px">
                                                    <div data-schedule-id="ce9f1c8b-965a-5682-9e42-98bbf60236e3"
                                                        data-calendar-id="2" class="tui-full-calendar-weekday-schedule "
                    ...
                    ">
                                                        <span class="tui-full-calendar-weekday-schedule-title"
                                                            data-title="Bu fuctohuk vekwowa."
                                                            title="Bu fuctohuk vekwowa."><span
            ...
            " style="top:34px;left:57.142857142857146%;width:42.85714285714286%;height:0px;
                margin-top:2px">
                                                    <div data-schedule-id="8cfd6aca-18f3-5978-abe1-a7756a9e821c"
                                                        data-calendar-id="8" class="tui-full-calendar-weekday-schedule "
                                                        style="height:24px; line-height:24px; border-radius: 3px;
                    margin-left: 8px;
                    margin-right: 8px;
            ...
            " style="top:34px;left:57.142857142857146%;width:42.85714285714286%;height:0px;
                margin-top:2px">
                                                    <div data-schedule-id="b711cc62-48f1-5b2f-a726-792cb0478cbc"
                                                        data-calendar-id="5" class="tui-full-calendar-weekday-schedule "
                                                        style="height:24px; line-height:24px; border-radius: 3px;
                    margin-left: 8px;
                    margin-right: 8px;
                    ...
                    ">
                                                        <span class="tui-full-calendar-weekday-schedule-title"
                                                            data-title="Ce poucjo absetla."
                                                            title="Ce poucjo absetla."><span
            ...
            " style="top:60px;left:71.42857142857143%;width:14.285714285714286%;height:0px;
                margin-top:2px">
                                                    <div data-schedule-id="4cd15324-455c-5732-8a13-3f7dc15ebdb0"
                                                        data-calendar-id="4" class="tui-full-calendar-weekday-schedule "
                                                        style="height:24px; line-height:24px; border-radius: 3px;
                    margin-left: 8px;
                    margin-right: 8px;
