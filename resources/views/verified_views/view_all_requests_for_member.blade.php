                                                ...
                                                <tr class="single-item odd" data-select2-id="select2-data-4-8ka4">
                                                    <td>
                                                        <a href="#" class="hstack gap-3">
                                                            ...
                                                            <div>
                                                                <span
                                                                    class="text-truncate-1-line">{{ $gallery->g_name }}</span>
                                                            </div>
                                                        </a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    @if($gallery->status == 1)
                                                    <td>
                                                        <a href="{{ url('/admin/view_gallery/'.$gallery->g_id) }}" class="btn btn-primary">
                                                    ...
                                                    @else
                                                    <td>
                                                        <a href="{{ url('/admin/view_pending/'.$gallery->g_id) }}" class="btn btn-primary">
                                                            <!-- <i class="feather-edit me-2"></i> -->
                                                            <span>View</span>
                                                        </a>
                                                    </td>
