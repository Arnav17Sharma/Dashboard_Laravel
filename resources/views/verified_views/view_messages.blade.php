    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">View Messages</h5>
            </div>
            <ul class="breadcrumb">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="sorting" tabindex="0" aria-controls="leadList"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Lead: activate to sort column ascending">Title</th>
                                                    <th class="sorting" tabindex="0" aria-controls="leadList"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Phone: activate to sort column ascending">Department
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="leadList"
                                                        rowspan="1" colspan="1"
                                                ...
                                                <tr class="single-item odd" data-select2-id="select2-data-4-8ka4">
                                                    <td>
                                                        <a href="#" class="hstack gap-3">
                                                            ...
                                                            <div>
                                                                <span
                                                                    class="text-truncate-1-line">{{ $notice->sender_name }}</span>
                                                            </div>
                                                        </a>
                                                    </td>
                                                    <td><a href="#">{{ $notice->sender_email }}</a>
                                                    </td>
                                                    <td>{{ $notice->created_at }}</td>
                                                    <td>
                                                        <a href="{{ url('admin/message/'.$notice->message_id) }}" target=”_blank”
