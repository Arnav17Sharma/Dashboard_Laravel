    ...
    <div class="header-wrapper">
        ...
        <div class="header-left d-flex align-items-center gap-4">
            ...
            <div class="nxl-navigation-toggle">
                <a href="#;" id="menu-mini-button" style="display: none;">
                    <i class="feather-align-left"></i>
                </a>
                <a href="#;" id="menu-expend-button" style="">
                            ...
                            <div class="recent-result px-4 py-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">CRM dashboard
                                                redesign</a>
                                            <p class="fs-11 text-muted mb-0">Home / project / crm</p>
                                        </div>
                                    </div>
                                    <div>
                                        <a href="#;" class="badge border rounded text-dark">/<i
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <div>
                                        <a href="#;" class="badge border rounded text-dark">N /<i
                                                class="feather-command ms-1 fs-10"></i></a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Invite project
                                                colleagues</a>
                                            <p class="fs-11 text-muted mb-0">Home / project / invite</p>
                                        </div>
                                    </div>
                                    <div>
                                        <a href="#;" class="badge border rounded text-dark">P /<i
                                                class="feather-command ms-1 fs-10"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="file-result px-4 py-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="#;" class="font-body fw-bold d-block mb-1">Dashboard Project
                                                Zip</a>
