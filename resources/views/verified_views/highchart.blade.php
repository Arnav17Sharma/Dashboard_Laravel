    ...
    <div class="row">
                ...
                <div class="card-body custom-card-action" style="position: relative;">
                    ...
                    <div class="resize-triggers">
                        <div class="expand-trigger">
                            <div style="width: 956px; height: 450px;"></div>
                        </div>
        ...
        <div class="col-xxl-4 col-lg-4">
            <div class="card stretch stretch-full">
                ...
                <div class="card-body" style="position: relative;">
                    ...
                    <div class="resize-triggers">
                        <div class="expand-trigger">
                            <div style="width: 956px; height: 451px;"></div>
                        </div>
                        <div class="contract-trigger"></div>
                    </div>
                </div>
        ...
        <div class="col-xxl-4 col-lg-4">
            <div class="card stretch stretch-full">
                ...
                <div class="card-body custom-card-action" style="position: relative;">
                    <div id="session-device-donut" style="min-height: 229.805px;">
                    ...
                    <div class="resize-triggers">
                        <div class="expand-trigger">
                            <div style="width: 956px; height: 552px;"></div>
                        </div>
                        <div class="contract-trigger"></div>
                    </div>
                </div>
