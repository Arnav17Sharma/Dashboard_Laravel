                    ...
                    <div class="card-body">
                        <div class="text-align-left">
                            <div class="">
                                    ...
                                    <h5 class="card-title">Title: {{ $notice_data->title }}</h5>
                                
                                
                                    <h5 class="card-title">Department: {{ $notice_data->department }}</h5>
                                
                                
                                    <h5 class="">Notice Type: 
                                        @foreach ($types as $type)
                                        @if($type->id == $notice_data->type)
                                        {{ $type->type }}
                                        @endif
                                        @endforeach
                                    </h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <a href="{{ url($attachment->attachment_url) }}" target="_blank"
                                    class="text-truncate-1-line">{{ $attachment->attachment_url }}</a>
                            </div>
                            @endforeach
                        </div>
                    </div>
