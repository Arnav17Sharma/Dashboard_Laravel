                        ...
                        <div class="card-body personal-info">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">Following information
                                        is publicly displayed, be careful! </span>
                                </h5>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="addressInput_2" cols="30" rows="3"
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="aboutInput" cols="30" rows="5"
                        ...
                        <div class="card-body additional-info">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">Communication details
                                        in case we want to connect with you.</span>
                                </h5>
                                <a href="javascript:void(0);" class="btn btn-sm btn-light-brand">Add New</a>
                            </div>
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control datepicker-input" id="dateofBirth"
                                            placeholder="Pick date of birth">
                                        <div class="datepicker datepicker-dropdown datepicker-orient-left datepicker-orient-top"
                                            style="left: 664.925px; top: 1390.5px;">
                                            <div class="datepicker-picker">
                                                <div class="datepicker-header">
                                                    <div class="datepicker-title" style="display: none;"></div>
                                                    <div class="datepicker-controls"><button type="button"
                                                            class="button prev-btn">«</button><button type="button"
                                                            class="button view-switch">June 2024</button><button
                                                            type="button" class="button next-btn">»</button></div>
                                                </div>
                                                    ...
                                                    <div class="datepicker-view">
                                                        <div class="days">
                                                            <div class="days-of-week"><span class="dow">Su</span><span
                                                                    ...
                                                                    class="dow">Fr</span><span class="dow">Sa</span>
                                                            </div>
                                                            <div class="datepicker-grid"><span
                                                                    class="datepicker-cell day prev"
                                                                    data-date="1716661800000">26</span><span
                                                                    class="datepicker-cell day prev"
                                                                    data-date="1716748200000">27</span><span
                                                                    class="datepicker-cell day prev"
                                                                    data-date="1716834600000">28</span><span
                                                                    class="datepicker-cell day prev"
                                                                    data-date="1716921000000">29</span><span
                                                                    class="datepicker-cell day prev"
                                                                    data-date="1717007400000">30</span><span
                                                                    class="datepicker-cell day prev"
                                                                    data-date="1717093800000">31</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717180200000">1</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717266600000">2</span><span
                                                                    class="datepicker-cell day focused"
                                                                    data-date="1717353000000">3</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717439400000">4</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717525800000">5</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717612200000">6</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717698600000">7</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717785000000">8</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717871400000">9</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1717957800000">10</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718044200000">11</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718130600000">12</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718217000000">13</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718303400000">14</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718389800000">15</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718476200000">16</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718562600000">17</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718649000000">18</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718735400000">19</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718821800000">20</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718908200000">21</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1718994600000">22</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719081000000">23</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719167400000">24</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719253800000">25</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719340200000">26</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719426600000">27</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719513000000">28</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719599400000">29</span><span
                                                                    class="datepicker-cell day"
                                                                    data-date="1719685800000">30</span><span
                                                                    class="datepicker-cell day next"
                                                                    data-date="1719772200000">1</span><span
                                                                    class="datepicker-cell day next"
                                                                    data-date="1719858600000">2</span><span
                                                                    class="datepicker-cell day next"
                                                                    data-date="1719945000000">3</span><span
                                                                    class="datepicker-cell day next"
                                                                    data-date="1720031400000">4</span><span
                                                                    class="datepicker-cell day next"
                                                                    data-date="1720117800000">5</span><span
                                                                    class="datepicker-cell day next"
                                                                    data-date="1720204200000">6</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="datepicker-footer">
                                                    <div class="datepicker-controls"><button type="button"
                                                            class="button today-btn"
                                                            style="display: none;">Today</button><button type="button"
                                                            class="button clear-btn">Clear</button></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible"
                                        data-select2-selector="country" data-select2-id="select2-data-49-2fgf"
                                        ...
                                        <option data-country="us" selected="" data-select2-id="select2-data-51-iput">
                                        ...
                                        dir="ltr" data-select2-id="select2-data-50-1nnx" style="width: 751.725px;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-j74e-container"
                                                aria-controls="select2-j74e-container"><span
                                                    class="select2-selection__rendered" id="select2-j74e-container"
                                                    role="textbox" aria-readonly="true" title="United States"><span
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible" data-select2-selector="state"
                                        data-select2-id="select2-data-61-5fpd" tabindex="-1" aria-hidden="true">
                                        <option data-state="al">Alabama</option>
                                        <option data-state="ak" selected="" data-select2-id="select2-data-63-hyzf">
                                            Alaska</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-62-cbnp" style="width: 751.725px;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-jgux-container"
                                                aria-controls="select2-jgux-container"><span
                                                    class="select2-selection__rendered" id="select2-jgux-container"
                                                    role="textbox" aria-readonly="true" title="Alaska"><span
                                                        class="hstack gap-3"> <img
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible" data-select2-selector="city"
                                        data-select2-id="select2-data-70-mb9k" tabindex="-1" aria-hidden="true">
                                        ...
                                        <option data-city="bg-teal" selected="" data-select2-id="select2-data-72-mmec">
                                            King Cove</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-71-qbtm" style="width: 751.725px;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-lttu-container"
                                                aria-controls="select2-lttu-container"><span
                                                    class="select2-selection__rendered" id="select2-lttu-container"
                                                    role="textbox" aria-readonly="true" title="King Cove"><span
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible" data-select2-selector="tzone"
                                        data-select2-id="select2-data-58-0r8d" tabindex="-1" aria-hidden="true">
                                        ...
                                        <option data-tzone="feather-moon">(GMT -4:00) Atlantic Time (Canada), Caracas,
                                            La Paz</option>
                                        ...
                                        <option data-tzone="feather-moon">(GMT -1:00) Azores, Cape Verde Islands
                                        </option>
                                        <option data-tzone="feather-sunrise" selected=""
                                            data-select2-id="select2-data-60-wxud">(GMT) Western Europe Time, London,
                                        ...
                                        <option data-tzone="feather-sun">(GMT +8:00) Beijing, Perth, Singapore, Hong
                                            Kong</option>
                                        <option data-tzone="feather-sun">(GMT +8:45) Eucla</option>
                                        <option data-tzone="feather-sun">(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo,
                                            Yakutsk</option>
                                        ...
                                        <option data-tzone="feather-sun">(GMT +12:00) Auckland, Wellington, Fiji,
                                            Kamchatka</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-59-khxw" style="width: 751.725px;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-qaew-container"
                                                aria-controls="select2-qaew-container"><span
                                                    class="select2-selection__rendered" id="select2-qaew-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="(GMT) Western Europe Time, London, Lisbon, Casablanca"><span
                                                        class="hstack gap-3 text-truncate-1-line"> <i
                                                            class="me-2 feather-sunrise"></i> (GMT) Western Europe Time,
                                                        London, Lisbon, Casablanca</span></span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                                </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible"
                                        data-select2-selector="language" multiple=""
                                        data-select2-id="select2-data-79-2ag2" tabindex="-1" aria-hidden="true">
                                        ...
                                        <option data-language="bg-black" selected=""
                                            data-select2-id="select2-data-81-iwek">Bengali - বাংলা</option>
                                        ...
                                        <option data-language="bg-black">Central Kurdish - کوردی (دەستنوسی عەرەبی)
                                        </option>
                                        ...
                                        <option data-language="bg-danger" selected=""
                                            data-select2-id="select2-data-82-qfer">English</option>
                                        ...
                                        <option data-language="bg-black">French (Switzerland) - français (Suisse)
                                        </option>
                                        ...
                                        <option data-language="bg-green">German (Austria) - Deutsch (Österreich)
                                        </option>
                                        <option data-language="bg-danger">German (Germany) - Deutsch (Deutschland)
                                        </option>
                                        <option data-language="bg-indigo">German (Liechtenstein) - Deutsch
                                            (Liechtenstein)</option>
                                        <option data-language="bg-cyan">German (Switzerland) - Deutsch (Schweiz)
                                        </option>
                                        ...
                                        <option data-language="bg-warning" selected=""
                                            data-select2-id="select2-data-83-2sh8">Hindi - हिन्दी</option>
                                        ...
                                        <option data-language="bg-danger">Portuguese (Brazil) - português (Brasil)
                                        </option>
                                        ...
                                        <option data-language="bg-warning">Romanian (Moldova) - română (Moldova)
                                        </option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-80-7u3p" style="width: 751.725px;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--multiple" role="combobox"
                                                aria-haspopup="true" aria-expanded="false" tabindex="-1"
                                                aria-disabled="false">
                                                <ul class="select2-selection__rendered" id="select2-tef1-container">
                                                    <li class="select2-selection__choice" title="Bengali - বাংলা"
                                                        data-select2-id="select2-data-84-z60y"><button type="button"
                                                            class="select2-selection__choice__remove" tabindex="-1"
                                                            title="Remove item" aria-label="Remove item"
                                                            aria-describedby="select2-tef1-container-choice-y58q-Bengali - বাংলা"><span
                                                                aria-hidden="true">×</span></button><span
                                                            class="select2-selection__choice__display"
                                                            id="select2-tef1-container-choice-y58q-Bengali - বাংলা"><span
                                                                class="hstack gap-3"> <span
                                                                    class="wd-7 ht-7 rounded-circle bg-black"></span>
                                                                Bengali - বাংলা</span></span></li>
                                                    <li class="select2-selection__choice" title="English"
                                                        data-select2-id="select2-data-85-w4rk"><button type="button"
                                                            class="select2-selection__choice__remove" tabindex="-1"
                                                            title="Remove item" aria-label="Remove item"
                                                            aria-describedby="select2-tef1-container-choice-ie9a-English"><span
                                                                aria-hidden="true">×</span></button><span
                                                            class="select2-selection__choice__display"
                                                            id="select2-tef1-container-choice-ie9a-English"><span
                                                                class="hstack gap-3"> <span
                                                                    class="wd-7 ht-7 rounded-circle bg-danger"></span>
                                                                English</span></span></li>
                                                    <li class="select2-selection__choice" title="Hindi - हिन्दी"
                                                        data-select2-id="select2-data-86-23xo"><button type="button"
                                                            class="select2-selection__choice__remove" tabindex="-1"
                                                            title="Remove item" aria-label="Remove item"
                                                            aria-describedby="select2-tef1-container-choice-1bxw-Hindi - हिन्दी"><span
                                                                aria-hidden="true">×</span></button><span
                                                            class="select2-selection__choice__display"
                                                            id="select2-tef1-container-choice-1bxw-Hindi - हिन्दी"><span
                                                                class="hstack gap-3"> <span
                                                                    class="wd-7 ht-7 rounded-circle bg-warning"></span>
                                                                Hindi - हिन्दी</span></span></li>
                                                        ...
                                                        aria-label="Search" aria-describedby="select2-tef1-container"
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible"
                                        data-select2-selector="currency" data-select2-id="select2-data-87-f6hq"
                                        tabindex="-1" aria-hidden="true">
                                        ...
                                        <option data-currency="us" selected="" data-select2-id="select2-data-89-32vs">
                                        ...
                                        dir="ltr" data-select2-id="select2-data-88-wb2k" style="width: 751.725px;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-3asz-container"
                                                aria-controls="select2-3asz-container"><span
                                                    class="select2-selection__rendered" id="select2-3asz-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="USD - US Dollar - $"><span class="hstack gap-3"> <img
                                                            src="./../assets/vendors/img/flags/1x1/us.svg"
                                                            class="avatar-image avatar-sm"> USD - US Dollar -
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-select form-control max-select select2-hidden-accessible"
                                        data-select2-selector="tag" multiple="" data-select2-id="select2-data-40-jku6"
                                        tabindex="-1" aria-hidden="true">
                                        ...
                                        <option value="danger" data-bg="bg-danger" selected=""
                                            data-select2-id="select2-data-42-0y22">Promotions</option>
                                        ...
                                        <option value="teal" data-bg="bg-teal" selected=""
                                            data-select2-id="select2-data-43-r7vh">High Budget</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap-5"
                                        dir="ltr" data-select2-id="select2-data-41-u7js" style="width: 751.725px;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--multiple" role="combobox"
                                                aria-haspopup="true" aria-expanded="false" tabindex="-1"
                                                aria-disabled="false">
                                                <ul class="select2-selection__rendered" id="select2-bhyk-container">
                                                    <li class="select2-selection__choice" title="Promotions"
                                                        data-select2-id="select2-data-44-yftl"><button type="button"
                                                            class="select2-selection__choice__remove" tabindex="-1"
                                                            title="Remove item" aria-label="Remove item"
                                                            aria-describedby="select2-bhyk-container-choice-61vs-danger"><span
                                                                aria-hidden="true">×</span></button><span
                                                            class="select2-selection__choice__display"
                                                            id="select2-bhyk-container-choice-61vs-danger"><span
                                                                class="hstack gap-2"> <span
                                                                    class="wd-7 ht-7 rounded-circle bg-danger"></span>
                                                                Promotions</span></span></li>
                                                    <li class="select2-selection__choice" title="High Budget"
                                                        data-select2-id="select2-data-45-gb1t"><button type="button"
                                                            class="select2-selection__choice__remove" tabindex="-1"
                                                            title="Remove item" aria-label="Remove item"
                                                            aria-describedby="select2-bhyk-container-choice-pnyk-teal"><span
                                                                aria-hidden="true">×</span></button><span
                                                            class="select2-selection__choice__display"
                                                            id="select2-bhyk-container-choice-pnyk-teal"><span
                                                                class="hstack gap-2"> <span
                                                                    class="wd-7 ht-7 rounded-circle bg-teal"></span>
                                                                High Budget</span></span></li>
                                                </ul><span class="select2-search select2-search--inline"><textarea
                                                        class="select2-search__field" type="search" tabindex="0"
                                                        autocorrect="off" autocapitalize="none" spellcheck="false"
                                                        role="searchbox" aria-autocomplete="list" autocomplete="off"
                                                        aria-label="Search" aria-describedby="select2-bhyk-container"
                                                        placeholder="" style="width: 0.75em;"></textarea></span>
                                            </span></span><span class="dropdown-wrapper"
                                            aria-hidden="true"></span></span>
                                </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible"
                                        data-select2-selector="status" data-select2-id="select2-data-46-6icb"
                                        tabindex="-1" aria-hidden="true">
                                        <option value="success" data-bg="bg-success" selected=""
                                            data-select2-id="select2-data-48-re2h">Active</option>
                                        <option value="warning" data-bg="bg-warning">Inactive</option>
                                        <option value="danger" data-bg="bg-danger">Declined</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap-5"
                                        dir="ltr" data-select2-id="select2-data-47-7l4a" style="width: 751.725px;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-osu8-container"
                                                aria-controls="select2-osu8-container"><span
                                                    class="select2-selection__rendered" id="select2-osu8-container"
                                                    role="textbox" aria-readonly="true" title="Active"><span
                                                        class="hstack gap-2"> <span
                                                            class="wd-7 ht-7 rounded-circle bg-success"></span>
                                                        Active</span></span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                                </div>
                            ...
                            <div class="row mb-0 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible"
                                        data-select2-selector="privacy" data-select2-id="select2-data-1-c2e5"
                                        tabindex="-1" aria-hidden="true">
                                        <option value="onlyme" data-icon="feather-lock">Only Me</option>
                                        <option value="everyone" data-icon="feather-globe" selected=""
                                            data-select2-id="select2-data-3-2o5g">Everyone</option>
                                        ...
                                        <option value="customselectever" data-icon="feather-settings">Custom Select Ever
                                        </option>
                                    </select><span class="select2 select2-container select2-container--bootstrap-5"
                                        dir="ltr" data-select2-id="select2-data-2-2d62" style="width: 751.725px;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-53l5-container"
                                                aria-controls="select2-53l5-container"><span
                                                    class="select2-selection__rendered" id="select2-53l5-container"
                                                    role="textbox" aria-readonly="true" title="Everyone"><span
                                                        class="hstack gap-3"><i class=" feather-globe"></i>
                                                        Everyone</span></span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                                </div>
                        ...
                        <div class="card-body pass-info">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">You can only change
                                        your password twice within 24 hours! </span>
                                </h5>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8 generate-pass">
                                    <div class="input-group field">
                                        ...
                                        <div class="input-group-text c-pointer gen-pass"><i class="feather-hash"></i>
                                        </div>
                                        <div class="input-group-text border-start bg-gray-2 c-pointer show-pass"><i></i>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body pass-security">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">Keep your account more
                                        secure with following preferences. </span>
                                </h5>
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Enable
                                            2-step authentication</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Protects you against password
                                            theft by requesting an authentication code via SMS on every login.</div>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Ask to
                                            change password on every 6 months</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">A simple but an effective way
                                            to be protected against data leaks and password theft.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                        ...
                        <div class="card-body pass-info">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">A billing address is
                                        the address associated with a payment method.</span>
                                </h5>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-map-pin"></i></div>
                                        <textarea class="form-control" id="addressInput_1" cols="30" rows="3"
                                            placeholder="Address"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible"
                                        data-select2-selector="country" data-select2-id="select2-data-52-656p"
                                        tabindex="-1" aria-hidden="true">
                                        <option data-country="af">Afghanistan</option>
                                        <option data-country="ax">Åland Islands</option>
                                        <option data-country="al">Albania</option>
                                        ...
                                        <option data-country="ae">United Arab Emirates</option>
                                        <option data-country="gb">United Kingdom</option>
                                        <option data-country="us" selected="" data-select2-id="select2-data-54-rmef">
                                            United States</option>
                                        <option data-country="um">U.S. Outlying Islands</option>
                                        <option data-country="uy">Uruguay</option>
                                        <option data-country="uz">Uzbekistan</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-53-c8jz" style="width: auto;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-2kxq-container"
                                                aria-controls="select2-2kxq-container"><span
                                                    class="select2-selection__rendered" id="select2-2kxq-container"
                                                    role="textbox" aria-readonly="true" title="United States"><span
                                                        class="hstack gap-3"> <img
                                                            src="./../assets/vendors/img/flags/1x1/us.svg"
                                                            class="avatar-image avatar-sm"> United
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible" data-select2-selector="state"
                                        data-select2-id="select2-data-64-8327" tabindex="-1" aria-hidden="true">
                                        <option data-state="al">Alabama</option>
                                        <option data-state="ak" selected="" data-select2-id="select2-data-66-hb44">
                                            Alaska</option>
                                        <option data-state="as">American Samoa</option>
                                        <option data-state="az">Arizona</option>
                                        <option data-state="ar">Arkansas</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-65-ch2b" style="width: auto;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-bwhy-container"
                                                aria-controls="select2-bwhy-container"><span
                                                    class="select2-selection__rendered" id="select2-bwhy-container"
                                                    role="textbox" aria-readonly="true" title="Alaska"><span
                                                        class="hstack gap-3"> <img
                                                            src="./../assets/vendors/img/flags/us/ak.png"
                                                            class="avatar-image avatar-sm"> Alaska</span></span><span
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible" data-select2-selector="city"
                                        data-select2-id="select2-data-73-x4ev" tabindex="-1" aria-hidden="true">
                                        <option data-city="bg-primary">Akutan</option>
                                        <option data-city="bg-secondary">Aleutians East Borough</option>
                                        <option data-city="bg-success">Aleutians West Census Area</option>
                                        <option data-city="bg-warning">Anchor Point</option>
                                        ...
                                        <option data-city="bg-success">Ketchikan</option>
                                        <option data-city="bg-indigo">Ketchikan Gateway Borough</option>
                                        <option data-city="bg-teal" selected="" data-select2-id="select2-data-75-ufc7">
                                            King Cove</option>
                                        <option data-city="bg-black">Knik-Fairview</option>
                                        <option data-city="bg-green">Kodiak</option>
                                        <option data-city="bg-cyan">Kodiak Island Borough</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-74-7b23" style="width: auto;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-212z-container"
                                                aria-controls="select2-212z-container"><span
                                                    class="select2-selection__rendered" id="select2-212z-container"
                                                    role="textbox" aria-readonly="true" title="King Cove"><span
                                                        class="hstack gap-3"> <span
                                                            class="wd-7 ht-7 rounded-circle bg-teal"></span> King
                                                        Cove</span></span><span class="select2-selection__arrow"
                        ...
                        <div class="card-body pass-info">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">A shipping address is
                                        the address to which a purchased item or service is to be delivered.</span>
                                </h5>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-map-pin"></i></div>
                                        <textarea class="form-control" id="addressInput_3" cols="30" rows="3"
                                            placeholder="Address"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible"
                                        data-select2-selector="country" data-select2-id="select2-data-55-5iwg"
                                        tabindex="-1" aria-hidden="true">
                                        <option data-country="af">Afghanistan</option>
                                        <option data-country="ax">Åland Islands</option>
                                        <option data-country="al">Albania</option>
                                        ...
                                        <option data-country="ae">United Arab Emirates</option>
                                        <option data-country="gb">United Kingdom</option>
                                        <option data-country="us" selected="" data-select2-id="select2-data-57-zo7a">
                                            United States</option>
                                        <option data-country="um">U.S. Outlying Islands</option>
                                        <option data-country="uy">Uruguay</option>
                                        <option data-country="uz">Uzbekistan</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-56-o7wz" style="width: auto;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-4zj0-container"
                                                aria-controls="select2-4zj0-container"><span
                                                    class="select2-selection__rendered" id="select2-4zj0-container"
                                                    role="textbox" aria-readonly="true" title="United States"><span
                                                        class="hstack gap-3"> <img
                                                            src="./../assets/vendors/img/flags/1x1/us.svg"
                                                            class="avatar-image avatar-sm"> United
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible" data-select2-selector="state"
                                        data-select2-id="select2-data-67-jdqe" tabindex="-1" aria-hidden="true">
                                        <option data-state="al">Alabama</option>
                                        <option data-state="ak" selected="" data-select2-id="select2-data-69-nmk7">
                                            Alaska</option>
                                        <option data-state="as">American Samoa</option>
                                        <option data-state="az">Arizona</option>
                                        <option data-state="ar">Arkansas</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-68-1g45" style="width: auto;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-dacq-container"
                                                aria-controls="select2-dacq-container"><span
                                                    class="select2-selection__rendered" id="select2-dacq-container"
                                                    role="textbox" aria-readonly="true" title="Alaska"><span
                                                        class="hstack gap-3"> <img
                                                            src="./../assets/vendors/img/flags/us/ak.png"
                                                            class="avatar-image avatar-sm"> Alaska</span></span><span
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control select2-hidden-accessible" data-select2-selector="city"
                                        data-select2-id="select2-data-76-ur3t" tabindex="-1" aria-hidden="true">
                                        <option data-city="bg-primary">Akutan</option>
                                        <option data-city="bg-secondary">Aleutians East Borough</option>
                                        <option data-city="bg-success">Aleutians West Census Area</option>
                                        <option data-city="bg-warning">Anchor Point</option>
                                        ...
                                        <option data-city="bg-success">Ketchikan</option>
                                        <option data-city="bg-indigo">Ketchikan Gateway Borough</option>
                                        <option data-city="bg-teal" selected="" data-select2-id="select2-data-78-794o">
                                            King Cove</option>
                                        <option data-city="bg-black">Knik-Fairview</option>
                                        <option data-city="bg-green">Kodiak</option>
                                        <option data-city="bg-cyan">Kodiak Island Borough</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-77-bl0l" style="width: auto;"><span
                                            class="selection"><span class="select2-selection select2-selection--single"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-dr7a-container"
                                                aria-controls="select2-dr7a-container"><span
                                                    class="select2-selection__rendered" id="select2-dr7a-container"
                                                    role="textbox" aria-readonly="true" title="King Cove"><span
                                                        class="hstack gap-3"> <span
                                                            class="wd-7 ht-7 rounded-circle bg-teal"></span> King
                                                        Cove</span></span><span class="select2-selection__arrow"
                    ...
                    <div class="tab-pane fade" id="subscriptionTab" role="tabpanel">
                        <div class="alert alert-dismissible m-4 p-4 d-flex alert-soft-teal-message" role="alert">
                            ...
                            <div>
                                ...
                                <p class="fs-12 fw-medium text-truncate-1-line">Your payment was declined. To start
                                    using tools, please <strong>Add Payment Method</strong></p>
                                <a href="javascript:void(0);"
                                    class="btn btn-sm bg-soft-teal text-teal d-inline-block">Add Payment Method</a>
                            ...
                            <div
                                ...
                                <div>
                                    <div class="fs-14 fw-bold text-dark mb-1">Your current plan is <a
                                            href="javascript:void(0);" class="badge bg-primary text-white ms-2">Team
                                            Plan</a></div>
                                ...
                                <div class="my-3 my-xxl-0 my-md-3 my-md-0">
                                    ...
                                    <div class="fs-12 text-muted mt-1">Billed Monthly / Next payment on 12/10/2023 for
                                        <strong class="text-dark">$62.48</strong></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="javascript:void(0);"
                                        ...
                                        <p class="fs-12 fw-normal text-muted text-truncate-2-line">Lorem, ipsum dolor
                                            sit amet consectetur adipisicing elit. Quod ipsa id corrupti modi, impedit
                                            exercitationem harum voluptates reiciendis.</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div
                                        ...
                                        <div class="d-sm-flex align-items-center">
                                            <div class="wd-100">
                                                <img src="assets/images/payment/mastercard.svg" class="img-fluid"
                                                    alt="">
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div
                                        ...
                                        <div class="d-sm-flex align-items-center">
                                            <div class="wd-100">
                                                <img src="assets/images/payment/american-express.svg" class="img-fluid"
                                                    alt="">
                                            </div>
                                            <div class="ms-0 ms-sm-3">
                                                <div class="text-dark fw-bold mb-2">Alexandra Della</div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Receive a notification for every successful
                                                payment.</small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-4-jik7"
                                                    tabindex="-1" aria-hidden="true">
                                                    ...
                                                    <option value="Email" data-icon="feather-mail" selected=""
                                                        data-select2-id="select2-data-6-6vki">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    </option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    </option>
                                                    <option value="Email+Push" data-icon="feather-mail">Email + Push
                                                    </option>
                                                    <option value="SMS+Email" data-icon="feather-smartphone">SMS + Email
                                                    </option>
                                                    <option value="SMS+Push+Email" data-icon="feather-smartphone">SMS +
                                                        Push + Email</option>
                                                </select><span
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-5-8s2i"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-8ld7-container"
                                                            aria-controls="select2-8ld7-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-8ld7-container" role="textbox"
                                                                aria-readonly="true" title="Email"><span
                                                                    class="hstack gap-3"><i class=" feather-mail"></i>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-7-acfd"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off" selected=""
                                                        data-select2-id="select2-data-9-pgpp">Deactivate</option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    </option>
                                                    <option value="Email+Push" data-icon="feather-mail">Email + Push
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-8-s4nl"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-zr2x-container"
                                                            aria-controls="select2-zr2x-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-zr2x-container" role="textbox"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-10-fver"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell" selected=""
                                                        data-select2-id="select2-data-12-75hv">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-11-0y3t"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-mx7p-container"
                                                            aria-controls="select2-mx7p-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-mx7p-container" role="textbox"
                                                                aria-readonly="true" title="Push"><span
                                                                    class="hstack gap-3"><i class=" feather-bell"></i>
                                                                    Push</span></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Receive a notification if a customer sends
                                                an incorrect amount to pay their invoice. </small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-13-ubzw"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail" selected=""
                                                        data-select2-id="select2-data-15-7z8v">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    </option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-14-6w1k"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-ute8-container"
                                                            aria-controls="select2-ute8-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-ute8-container" role="textbox"
                                                                aria-readonly="true" title="Email"><span
                                                                    class="hstack gap-3"><i class=" feather-mail"></i>
                                                                    Email</span></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Send an email reminding me to rate an item a
                                                week after purchase </small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-16-fde1"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off" selected=""
                                                        data-select2-id="select2-data-18-z0uh">Deactivate</option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    </option>
                                                    <option value="Email+Push" data-icon="feather-mail">Email + Push
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-17-473m"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-do91-container"
                                                            aria-controls="select2-do91-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-do91-container" role="textbox"
                                                                aria-readonly="true" title="Deactivate"><span
                                                                    class="hstack gap-3"><i
                                                                        class=" feather-bell-off"></i>
                                                                    Deactivate</span></span><span
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Send an email when an item I've purchased is
                                                updated </small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-19-8awm"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone" selected=""
                                                        data-select2-id="select2-data-21-1617">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-20-28fy"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-ti14-container"
                                                            aria-controls="select2-ti14-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-ti14-container" role="textbox"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Send me an email when someone comments on
                                                one of my items </small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-22-izzn"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell" selected=""
                                                        data-select2-id="select2-data-24-g9o3">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-23-nul6"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-1r1o-container"
                                                            aria-controls="select2-1r1o-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-1r1o-container" role="textbox"
                                                                aria-readonly="true" title="Push"><span
                                                                    class="hstack gap-3"><i class=" feather-bell"></i>
                                                                    Push</span></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Send me an email when someone comments on
                                                one of my team items </small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-25-2r25"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat" selected=""
                                                        data-select2-id="select2-data-27-o88c">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    </option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-26-ipr7"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-x023-container"
                                                            aria-controls="select2-x023-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-x023-container" role="textbox"
                                                                aria-readonly="true" title="Repeat"><span
                                                                    class="hstack gap-3"><i class=" feather-repeat"></i>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Send me an email when my items are approved
                                                or rejected </small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-28-va2m"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off" selected=""
                                                        data-select2-id="select2-data-30-q5dt">Deactivate</option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    </option>
                                                    <option value="Email+Push" data-icon="feather-mail">Email + Push
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-29-5a9v"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-qb0j-container"
                                                            aria-controls="select2-qb0j-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-qb0j-container" role="textbox"
                                                                aria-readonly="true" title="Deactivate"><span
                                                                    class="hstack gap-3"><i
                                                                        class=" feather-bell-off"></i>
                                                                    Deactivate</span></span><span
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-31-llov"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off" selected=""
                                                        data-select2-id="select2-data-33-4oe7">Deactivate</option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    </option>
                                                    <option value="Email+Push" data-icon="feather-mail">Email + Push
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-32-4mu1"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-5vyw-container"
                                                            aria-controls="select2-5vyw-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-5vyw-container" role="textbox"
                                                                aria-readonly="true" title="Deactivate"><span
                                                                    class="hstack gap-3"><i
                                                                        class=" feather-bell-off"></i>
                                                                    Deactivate</span></span><span
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="fs-12 text-muted">Send me emails showing my soon to expire
                                                support entitlements </small>
                                        </td>
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-34-b81n"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell">Push</option>
                                                    <option value="Email" data-icon="feather-mail" selected=""
                                                        data-select2-id="select2-data-36-5dc0">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    </option>
                                                    <option value="SMS+Push" data-icon="feather-smartphone">SMS + Push
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-35-4nm3"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-6vu7-container"
                                                            aria-controls="select2-6vu7-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-6vu7-container" role="textbox"
                                                                aria-readonly="true" title="Email"><span
                                                                    class="hstack gap-3"><i class=" feather-mail"></i>
                                                                    Email</span></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="form-group select-wd-lg">
                                                <select class="form-control select2-hidden-accessible"
                                                    data-select2-selector="icon" data-select2-id="select2-data-37-ffys"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option value="SMS" data-icon="feather-smartphone">SMS</option>
                                                    <option value="Push" data-icon="feather-bell" selected=""
                                                        data-select2-id="select2-data-39-z0l8">Push</option>
                                                    <option value="Email" data-icon="feather-mail">Email</option>
                                                    <option value="Repeat" data-icon="feather-repeat">Repeat</option>
                                                    <option value="Deactivate" data-icon="feather-bell-off">Deactivate
                                                    </option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap-5"
                                                    dir="ltr" data-select2-id="select2-data-38-t2on"
                                                    style="width: auto;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-0l6p-container"
                                                            aria-controls="select2-0l6p-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-0l6p-container" role="textbox"
                                                                aria-readonly="true" title="Push"><span
                                                                    class="hstack gap-3"><i class=" feather-bell"></i>
                                                                    Push</span></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                        ...
                        <div class="card-body notify-activity-section">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">Lookup you account
                                        activity checkup.</span>
                                </h5>
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Someone
                                            comments on one of my items</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">If someone comments on one of
                                            your items, it's important to respond in a timely and appropriate manner.
                                        </div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Someone
                                            replies to my job posting</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Great! It's always exciting
                                            to hear from someone who's interested in a job posting you've put out.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Someone
                                            mentions or follows me</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">If you received a
                                            notification that someone mentioned or followed you, take a moment to read
                                            it and understand what it means.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                        ...
                        <div class="card-body development-connections">
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Google
                                            Drive: Cloud Storage &amp; File Sharing</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Google's powerful search
                                            capabilities are embedded in Drive and offer speed, reliability, and
                                            collaboration. And features like Drive search chips help your team ...</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Dropbox:
                                            Cloud Storage &amp; File Sharing</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Dropbox brings
                                            everything—traditional files, cloud content, and web shortcuts—together in
                                            one place. ... Save and access your files from any device, and share ...
                                        </div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    ...
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitchDropbox"
                                        checked="">
                                </div>
                            </div>
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">GitHub:
                                            Where the world builds software</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">GitHub is where over 83
                                            million developers shape the future of software, together. Contribute to the
                                            open source community, manage your Git repositories, ...</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                                        for="formSwitchGitHub"></label>
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitchGitHub"
                                        checked="">
                                </div>
                            </div>
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">GitLab:
                                            The One DevOps Platform</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">GitLab helps you automate the
                                            builds, integration, and verification of your code. With SAST, DAST, code
                                            quality analysis, plus pipelines that enable ...</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Shopify:
                                            Ecommerce Developers Platform</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Try Shopify free and start a
                                            business or grow an existing one. Get more than ecommerce software with
                                            tools to manage every part of your business.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                                        for="formSwitchShopify"></label>
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitchShopify"
                                        checked="">
                                </div>
                            </div>
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);"
                                            class="fw-bold mb-1 text-truncate-1-line">WhatsApp: WhatsApp from Facebook
                                            is a FREE messaging and video calling app</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Reliable messaging. With
                                            WhatsApp, you'll get fast, simple, secure messaging and calling for free*,
                                            available on phones all ...</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                        ...
                        <div class="card-body social-connections">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    ...
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">Social connections
                                        increase your audience.</span>
                                </h5>
                                <a href="javascript:void(0);" class="btn btn-sm btn-light-brand">View Connection</a>
                            </div>
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);"
                                            class="fw-bold mb-1 text-truncate-1-line">Facebook: The World Most Popular
                                            Social Network</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Create an account or log into
                                            Facebook. Connect with friends, family and other people you know. Share
                                            photos and videos, send messages and get updates.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                                        for="formSwitchFacebook"></label>
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitchFacebook"
                                        checked="">
                                </div>
                            </div>
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <div class="fs-12 text-muted text-truncate-1-line">Create an account or log in
                                            to Instagram - A simple, fun &amp; creative way to capture, edit &amp; share
                                            photos, videos &amp; messages with friends &amp; family.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Twitter:
                                            It's what's happening / Twitter </a>
                                        <div class="fs-12 text-muted text-truncate-1-line">From breaking news and
                                            entertainment to sports and politics, get the full story with all the live
                                            commentary.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    ...
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitchTwitter"
                                        checked="">
                                </div>
                            </div>
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">Spotify:
                                            Web Player: Music for everyone </a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Spotify is a digital music
                                            service that gives you access to millions of songs.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                                        for="formSwitchSpotify"></label>
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitchSpotify"
                                        checked="">
                                </div>
                            </div>
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);" class="fw-bold mb-1 text-truncate-1-line">YouTube:
                                            The World Largest Video Sharing Platform</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Enjoy the videos and music
                                            you love, upload original content, and share it all with friends, family,
                                            and the world on YouTube.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                            ...
                            <div
                                ...
                                <div class="hstack me-4">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:void(0);"
                                            class="fw-bold mb-1 text-truncate-1-line">Pinterest: Discover recipes, home
                                            ideas, style inspiration and other ideas to try</a>
                                        <div class="fs-12 text-muted text-truncate-1-line">Pinterest is an image sharing
                                            and social media service designed to enable saving and discovery of
                                            information on the internet using images.</div>
                                    </div>
                                </div>
                                <div class="form-check form-switch form-switch-sm">
                                    <label class="form-check-label fw-500 text-dark c-pointer"
                                        for="formSwitchPinterest"></label>
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitchPinterest"
                                        checked="">
                                </div>
                            </div>
                        </div>
