                                    ...
                                    <div class="item">
                                        <div class="update-one__single">
                                            <p class="update-one__text">
                                                <a style="color: white;" onMouseOver="this.style.color='white'" onMouseOut="this.style.color='white'" class="" href="{{ url('/view_notice/'.$notice->id) }}">
                                                @php
                                                if(strlen($notice->title) > 60) {
                                                $notice->title = substr($notice->title, 0, 60) . '...';
                                                }
                                                @endphp
                                                {{ $notice->title }}
                                                </a>
