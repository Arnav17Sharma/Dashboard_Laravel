...
@section('title', 'Minstry of Electronics & IT | Subject Matter of formulated policy')
@section('content')
<section class="page-header">
    ...
    <div class="container">
        <div class="page-header__inner" style="padding-top:50px;">
            <h2>Subject Matter of formulated policy</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="#">About Us</a></li>
                <li><span>/</span></li>
                <li>Subject Matter of formulated policy</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-xl-10 col-lg-10">
                <div class="update-one__right">
                    <div class="update-one_carousel thm-owl_carousel owl-theme owl-carousel owl-loaded owl-drag"
                        data-owl-options="{
                                &quot;items&quot;: 1,
                                &quot;margin&quot;: 10,
                                &quot;smartSpeed&quot;: 500,
                        ...
                        <div class="scheme">
                            <div class="schemes">
                                <div class="scheme-title "
                                    style=" padding-left:13px;margin-top:23px; font-weight:900px;">
                                    <h4>
                                        Schemes-
                                    </h4>
                                </div>
                                        ...
                                        <ul>
                                            <p>
                                                ...
                                                <li> Establishment of software technology parks and other similar
                                                    institutions.</li>
                                                <li> Development of Geographic Information System and its proper use in
                                                    all
                                                    departments.</li>
                                                ...
                                                <li> Coordinating with information technology institutions and
                                                    organizations
                                                    located in India and abroad.</li>

                                                <li> Coordination for the implementation of state's information
                                                    technology
                                                    policy and action plans.</li>

                                                <li> Organizing seminars, workshops, conferences etc. related to
                                                    information
                                                    technology.</li>
                                                <li>To promote the development of information technology in the state
                                                    and
                                                    implement the work plan of information technology in the
                                                    socio-economic
                                                    field.
                                                </li>
                                                ...
                                                <li> To make computerized automation system in all the departments of
                                                    the
                                                    state government, urban and rural and local bodies.</li>
                                                <li> Coordinating between all the departments of the state government,
                                                    urban
                                                ...
                                                <li>To encourage and promote research and development work related to
                                                    information technology, which includes increasing the use of Hindi
                                                    in
                                                    information technology.</li>
                                                ...
                                                <li> Establishment of rural internet and other internet based
                                                    information
                                                ...
                                                <li> To establish coordination and network between investors, industry /
                                                    business organizations and financial institutions for the
                                                    development of
