...
@section('title', 'Minstry of Electronics & IT | Organisation Chart')
@section('content')
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="department-details__left">
                    <div class="department-details__icon-and-title">
                        ...
                        <h3 class="department-details__title">Organisation Chart</h3>
                    </div>
                    <div class="faq-one__right mt-3">
                        <img src="{{ asset('eit_assets/images/org_chart.jpg'); }}" alt="" style="max-width: 100vh;">
                    </div>
                </div>
            </div>
